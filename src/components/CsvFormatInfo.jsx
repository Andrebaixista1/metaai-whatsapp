  ...
  return (
    <Alert variant="info" className="mb-3">
      ...
      <Collapse in={showDetails}>
        <div className="mt-3">
          <h6>📋 Estrutura obrigatória:</h6>
          <ul className="mb-3">
            <li><strong>Separador:</strong> Ponto e vírgula (;)</li>
            <li><strong>Codificação:</strong> UTF-8</li>
            <li><strong>Primeira linha:</strong> Cabeçalho com nomes das colunas</li>
          </ul>
          
          <h6>📊 Colunas:</h6>
          <ul className="mb-3">
            <li><strong>name:</strong> Nome completo do contato <span className="text-danger">(obrigatório)</span></li>
            <li><strong>phone:</strong> Número do telefone <span className="text-danger">(obrigatório)</span></li>
          ...
          <div className="bg-dark p-2 rounded">
            <code className="text-light">
              ...
              <small className="text-success">* Pedro não tem email (opcional)</small>
            </code>
          </div>
        </div>
      </Collapse>
